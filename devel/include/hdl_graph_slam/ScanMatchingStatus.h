...
struct ScanMatchingStatus_
{
  ...
  _prediction_labels_type prediction_labels;
   ...
   typedef std::vector< ::geometry_msgs::Pose_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Pose_<ContainerAllocator> >::other >  _prediction_errors_type;
