...
(cl:in-package my_server_class-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <add_two_ints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_two_ints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_server_class-srv:<add_two_ints-request> is deprecated: use my_server_class-srv:add_two_ints-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <add_two_ints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_server_class-srv:a-val is deprecated.  Use my_server_class-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <add_two_ints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_server_class-srv:b-val is deprecated.  Use my_server_class-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_two_ints-request>)))
  ...
  "my_server_class/add_two_intsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_two_ints-request)))
  "Returns string type for a service object of type 'add_two_ints-request"
  "my_server_class/add_two_intsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <add_two_ints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_two_ints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_server_class-srv:<add_two_ints-response> is deprecated: use my_server_class-srv:add_two_ints-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <add_two_ints-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_server_class-srv:sum-val is deprecated.  Use my_server_class-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_two_ints-response>)))
  ...
  "my_server_class/add_two_intsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_two_ints-response)))
  "Returns string type for a service object of type 'add_two_ints-response"
  "my_server_class/add_two_intsResponse")
